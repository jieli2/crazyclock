...
import com.rock.alarmclock.preferences.AlarmPreference.Key;
...
//								mediaPlayer.setVolume(1.0f, 1.0f);
		...
		case MULTIPLE_LIST:
			...
			break;
		case JSON:
			Intent intent = new Intent(this, AlarmTaskActivity.class);
			
			
			intent.putExtra("alarm", getMathAlarm());
	...
	protected void onActivityResult(int requestCode,int resultCode,Intent data){
		...
		case RESULT_OK:
	        ...
	        this.setMathAlarm((Alarm)bundle.getSerializable("alarm"));
		}
	}
	@Override
	...
	protected void onResume() {
		...
		//TODO: layout and test
		//Toast.makeText(this, this.getMathAlarm()==null?"haha":this.getMathAlarm().getExtra(),Toast.LENGTH_LONG).show();  
