package com.rock.alarmclock.database;
...
import com.rock.alarmclock.main.Alarm.Difficulty;
...
public class Database extends SQLiteOpenHelper {
	...
	public static final String COLUMN_ALARM_EXTRA = "alarm_extra";
	...
	public static long create(Alarm alarm) {
		...
		cv.put(COLUMN_ALARM_EXTRA, alarm.getExtra());
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("CREATE TABLE IF NOT EXISTS " + ALARM_TABLE + " ( " 
				...
				+ COLUMN_ALARM_EXTRA + " TEXT NOT NULL)");
	}
	...
	public static List<Alarm> getAll() {
		...
		if (cursor.moveToFirst()) {
			...
			do {
				...
				alarm.setExtra(cursor.getString(8));
				alarms.add(alarm);
